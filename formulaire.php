<form method='post'>
				    <input class="search-query" type="text" placeholder="Insérer le lien de l'image" name='image'>
				    </br>
				    ...
				    <input class="search-query" type="text" placeholder="Genre" name='genres'> </br>
