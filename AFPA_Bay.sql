...
--
-- Host: localhost:3306
-- Generation Time: Jul 03, 2017 at 09:59 AM
...
--
ALTER TABLE `Film`
  ADD CONSTRAINT `Film_ibfk_1` FOREIGN KEY (`genres`) REFERENCES `Genres` (`id`);
